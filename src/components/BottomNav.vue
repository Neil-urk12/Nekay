...
<template>
  <nav class="bottom-nav">
    <div class="nav-container">
      <router-link to="/home" class="nav-link" :class="[{ active: route.path === '/' }]">
        <span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
          <path
      ...
      <router-link
        to="/pomodoro"
        class="nav-link" :class="[{ active: route.path === '/pomodoro' }]"
      >
      ...
      <router-link
        to="/folders"
        class="nav-link" :class="[{ active: route.path === '/folders' }]"
      >
        <span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <path
      ...
      <router-link
        to="/journal"
        class="nav-link" :class="[{ active: route.path === '/journal' }]"
      >
        <span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          <path
      ...
      <router-link
        to="/me"
        class="nav-link" :class="[{ active: route.path === '/me' }]"
      >
        <span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          <path
